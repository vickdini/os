...
build: rust $(kernel_object_files) $(x86_64_object_files)
	...
	grub-mkrescue -o dist/x86_64/kernel.iso --modules="biosdisk part_msdos part_gpt" --directory=/usr/lib/grub/i386-pc --directory=/usr/lib/grub/x86_64-efi --efi-directory=targets/x86_64/iso/efi/boot
